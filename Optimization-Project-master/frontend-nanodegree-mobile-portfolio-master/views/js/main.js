...
var resizePizzas = function(size) {
  ...
  // **Optimization** Changed way to get containers to getElementsByClassName and took this task out of for loop.
  // Took off iteration through all containers to determine new size since all pizza's are the same size.
...
// Moved scrollTop location to outside for loop to get rid of forced synchronized layout
function updatePositions() {
  ...
  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin((scrollTopNow / 1250) + (i % 5));
